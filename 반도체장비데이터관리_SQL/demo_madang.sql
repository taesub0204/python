...
select * from customer where address like '%서울%'; -- 17
select * from book where bookname like '%축구%'; -- 18
select * from book where bookname like '%야구%'; -- 19


-- 20
select * from  book where publisher = '굿스포츠' and price > 20000;

-- 21
select * from Orders where saleprice > 20000 and custid = 2;
-- like 패턴연산자 
