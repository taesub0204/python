...
namespace LMStockManageSystem
{
    internal class Customer : Person
    {
       ...
       // public string phoneNumber { get; set; }
        ...
        {
            Console.WriteLine($"{name}님이 {productName} {quantity}개를 구매하셨습니다.");
       ...
       {
           Console.WriteLine($"{name} {customerID}님이 {visitDate.ToShortDateString()}에 매장을 방문하셨습니다.");
        }
        ...
        {
            Console.WriteLine($"{name} {customerID}님이 {productName} {quantity}개를 반품하셨습니다.");
        }
        ...
        {
            Console.WriteLine($"{name} {customerID}님이 {productName} {quantity}개를 교환하셨습니다.");
        }

        //환불학 메서드 (예시로 상품명과 수량을 매개변수로 받음)
        public void RefundProduct(string productName, int quantity)
        {
            Console.WriteLine($"{name} {customerID}님이 {productName} {quantity}개를 환불하셨습니다.");
        }
        ...
        {
            points += pointsToEarn;
            Console.WriteLine($"{name} {customerID}님이 {pointsToEarn} 포인트를 적립하셨습니다. 현재 포인트: {points}");
        }
