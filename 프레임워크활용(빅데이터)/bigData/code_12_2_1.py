...
model1 = KMeans(n_clusters = 2, n_init = 10, random_state = 123) # 군집 개수 2개로 설정
model1.fit(df_scaled)
model1.cluster_centers_ # 군집 중심 좌표
model1.labels_ # 각 행의 군집 번호
model1.inertia_ # 군집 평가 점수



transform['cluster1'] = model.labels_ # 군집 번호 열 추가
transform['cluster2'] = model1.labels_ # 군집 번호 열 추가
